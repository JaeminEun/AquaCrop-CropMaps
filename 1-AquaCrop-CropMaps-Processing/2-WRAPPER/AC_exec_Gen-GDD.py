...
def wrapper(coords):  # wraps all functions into one list of functions
    ...
    input_dir =  '/staging/leuven/stg_00024/OUTPUT/jaemine/LIS-Wrapper-GDD/MERRA-Grid/GDD-Crop/INPUT/'
    dir_out = '/staging/leuven/stg_00024/OUTPUT/jaemine/LIS-Wrapper-GDD/MERRA-Grid/GDD-Crop/OUTPUT/'
    ...
    if os.path.exists(dir_crop +"GDD_" +fname+'.CRO'): # To run only for pixel
